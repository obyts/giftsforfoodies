...
/** Location dropdown menu (Giftory-style). Regions with cities show "+" and expand; empty cities = link only, no submenu. */
export const locationMenuRegions: { region: string; cities: string[] }[] = [
  // Column 1 — with and without submenu
  { region: 'Alabama', cities: ['Birmingham', 'Huntsville', 'Mobile', 'Montgomery'] },
  { region: 'Alaska', cities: [] },
  { region: 'Arizona', cities: ['Phoenix', 'Scottsdale', 'Sedona', 'Tucson', 'Grand Canyon', 'Flagstaff'] },
  { region: 'Arkansas', cities: ['Little Rock', 'Fayetteville'] },
  { region: 'California', cities: ['Los Angeles', 'San Francisco', 'San Diego', 'Sacramento', 'San Jose', 'Santa Barbara', 'Orange County', 'Wine Country', 'Palm Springs', 'Yosemite', 'Inland Empire', 'San Jose'] },
  { region: 'Colorado', cities: ['Denver', 'Boulder', 'Colorado Springs', 'Aspen', 'Vail', 'Fort Collins'] },
  { region: 'Connecticut', cities: [] },
  { region: 'Delaware', cities: [] },
  // Column 2
  { region: 'Florida', cities: ['Miami', 'Orlando', 'Tampa', 'Jacksonville', 'Fort Lauderdale', 'Key West', 'Naples', 'West Palm Beach', 'St. Petersburg', 'Sarasota'] },
  { region: 'Georgia', cities: ['Atlanta', 'Savannah', 'Augusta', 'Athens', 'Macon'] },
  { region: 'Hawaii', cities: ['Honolulu', 'Maui', 'Big Island', 'Kauai', 'Oahu'] },
  { region: 'Idaho', cities: [] },
  { region: 'Illinois', cities: ['Chicago', 'Springfield', 'Naperville', 'Peoria', 'Rockford', 'Evanston'] },
  { region: 'Indiana', cities: ['Indianapolis', 'Fort Wayne', 'Bloomington', 'South Bend'] },
  { region: 'Iowa', cities: [] },
  { region: 'Kansas', cities: ['Kansas City', 'Wichita'] },
  // Column 3
  { region: 'Kentucky', cities: ['Louisville', 'Lexington', 'Bowling Green'] },
  { region: 'Louisiana', cities: ['New Orleans', 'Baton Rouge', 'Lafayette'] },
  { region: 'Maine', cities: ['Portland', 'Bar Harbor'] },
  { region: 'Maryland', cities: ['Baltimore', 'Annapolis', 'Ocean City'] },
  { region: 'Massachusetts', cities: ['Boston', 'Cambridge', 'Worcester', 'Salem', 'Provincetown', 'Cape Cod'] },
  { region: 'Michigan', cities: ['Detroit', 'Ann Arbor', 'Grand Rapids', 'Traverse City'] },
  { region: 'Minnesota', cities: ['Minneapolis', 'Saint Paul', 'Duluth'] },
  { region: 'Mississippi', cities: [] },
  // Column 4
  { region: 'Missouri', cities: ['Kansas City', 'St. Louis', 'Branson', 'Springfield'] },
  { region: 'Montana', cities: [] },
  { region: 'Nebraska', cities: ['Omaha', 'Lincoln'] },
  { region: 'Nevada', cities: ['Las Vegas', 'Reno', 'Lake Tahoe', 'Henderson'] },
  { region: 'New Hampshire', cities: [] },
  { region: 'New Jersey', cities: ['Newark', 'Jersey City', 'Atlantic City', 'Princeton'] },
  { region: 'New Mexico', cities: ['Santa Fe', 'Albuquerque', 'Taos'] },
  { region: 'New York', cities: ['New York City', 'Syracuse', 'Buffalo', 'Rochester', 'Albany', 'Long Island', 'Brooklyn', 'Hamptons'] },
  // Column 5
  { region: 'North Carolina', cities: ['Charlotte', 'Raleigh', 'Asheville', 'Durham', 'Wilmington', 'Outer Banks'] },
  { region: 'North Dakota', cities: [] },
  { region: 'Ohio', cities: ['Cincinnati', 'Cleveland', 'Columbus', 'Dayton'] },
  { region: 'Oklahoma', cities: ['Oklahoma City', 'Tulsa'] },
  { region: 'Oregon', cities: ['Portland', 'Eugene', 'Bend', 'Ashland'] },
  { region: 'Pennsylvania', cities: ['Philadelphia', 'Pittsburgh', 'Lancaster', 'Gettysburg'] },
  { region: 'Rhode Island', cities: [] },
  { region: 'South Carolina', cities: ['Charleston', 'Hilton Head', 'Myrtle Beach', 'Greenville'] },
  // Column 6 (will wrap or 6th col)
  { region: 'South Dakota', cities: [] },
  { region: 'Tennessee', cities: ['Nashville', 'Memphis', 'Knoxville', 'Chattanooga', 'Gatlinburg'] },
  { region: 'Texas', cities: ['Austin', 'Dallas-Fort Worth', 'Houston', 'San Antonio', 'Fort Worth', 'El Paso', 'Galveston', 'Corpus Christi'] },
  { region: 'Utah', cities: ['Salt Lake City', 'Park City', 'Moab', 'St. George'] },
  { region: 'Vermont', cities: [] },
  { region: 'Virginia', cities: ['Arlington', 'Norfolk', 'Richmond', 'Virginia Beach', 'Charlottesville'] },
  { region: 'Washington', cities: ['Seattle', 'Spokane', 'Tacoma', 'Bellevue', 'Olympic Peninsula', 'San Juan Islands'] },
  { region: 'Washington DC', cities: [] },
  { region: 'West Virginia', cities: [] },
  { region: 'Wisconsin', cities: ['Milwaukee', 'Madison', 'Door County', 'Lake Geneva'] },
  { region: 'Wyoming', cities: ['Jackson Hole', 'Yellowstone', 'Cody'] },
  // International
  { region: 'Europe', cities: ['London', 'Paris', 'Barcelona', 'Rome', 'Amsterdam', 'Madrid', 'Lisbon', 'Berlin', 'Vienna', 'Dublin', 'Prague', 'Budapest'] },
  { region: 'Canada', cities: ['Toronto', 'Vancouver', 'Montreal', 'Calgary', 'Ottawa', 'Quebec City', 'Victoria'] },
  { region: 'Asia & Pacific', cities: ['Tokyo', 'Sydney', 'Singapore', 'Hong Kong', 'Bangkok', 'Bali', 'Seoul', 'Melbourne'] },
];
